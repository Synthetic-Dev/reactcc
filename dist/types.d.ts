...
export type ElementType = typeof ElementBase | Component | Function | ExoticComponent | keyof JSX.IntrinsicElements;
export type Props<T extends ElementType> = (T extends typeof ElementBase ? T["props"] : T extends Component ? Parameters<T>[0] : T extends keyof JSX.IntrinsicElements ? JSX.IntrinsicElements[T] : T extends ExoticComponent ? T["props"] : null) | {};
export type ElementChildren<T extends ElementType> = Props<T> extends PropsWithChildren<infer C> ? C : never;
...
export declare const INTRINSIC_ELEMENTS: {
    line: typeof Line;
    frame: typeof Frame;
    text: typeof Text;
    image: typeof Image;
};
export type IntrinsicElementClasses = typeof INTRINSIC_ELEMENTS[keyof typeof INTRINSIC_ELEMENTS];
declare global {
    namespace JSX {

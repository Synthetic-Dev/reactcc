...
local Text = ____exports.default
Text.name = "Text"
__TS__ClassExtends(Text, DrawableElement)
function Text.prototype.____constructor(self, parent)
    DrawableElement.prototype.____constructor(self, parent)
    self.textOffset = Vector2.zero
end
function Text.prototype.__defaultProps(self)
    return __TS__ObjectAssign(
        DrawableElement.prototype.__defaultProps(self),
        {text = "", textColor = colors.white}
    )
end
function Text.prototype.__updateProps(self, props)
...
function Text.prototype.beforeDraw(self, window)
    DrawableElement.prototype.beforeDraw(self, window)
    window.setTextColor(self.textColor)
end
function Text.prototype.draw(self, window)
